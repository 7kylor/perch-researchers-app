...
export const ResearchModal: React.FC<ResearchModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-7xl h-full max-h-[90vh] bg-white rounded-lg shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">Research & Analytics</h1>
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-medium text-gray-900">Academic Search</h3>
                    </div>
